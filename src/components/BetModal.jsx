    ...
    <Modal show={show} title={title} onClose={onClose} footer={footer}>
      <div className="flex flex-col items-center">
        ...
        <div className="flex items-center justify-center">
          ...
          <div className="mx-4 flex items-center justify-center w-24 bg-[#eeebe3] border border-[#e0c08b] rounded-xl shadow-[0_2px_0_#c7994a,0_4px_2px_rgba(0,0,0,0.3)] py-1">
